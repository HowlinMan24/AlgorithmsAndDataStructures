...
public class Speluvanje {
    public static void main(String[] args) throws IOException {
        ...
        tabela = new OBHT<Zbor, String>(1000);
        ...
        for (int i = 0; i < N; i++) {
            ...
            tabela.insert(new Zbor(word.replaceAll("[^a-zA-Z]", "")), word.replaceAll("[^a-zA-Z]", ""));
        }
...
//        System.out.println(st.toString());
        ...
        for (int i = 0; i < parts.length; i++) {
            Zbor word = new Zbor(parts[i].toLowerCase());
            if (tabela.search(word) == -1) {
